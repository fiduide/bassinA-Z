...
<head>
    ...
    <link rel="stylesheet" type="text/css" title="style" href="css/style_addPhotos.css"/>
...
<div id="header" class="header">
        <img class ="header" src="assets/img/banniere3.png">
    </div>
...
<form id="uploadForm" enctype="multipart/form-data">
            ...
            <h1 class="h3 text-primary">Ajouter des photos</h1>
            <table class="w-100 mt-3 text-center" id="myPara">
                <tr>
                    <td>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1" class="mt-3">Titre :</label>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1" class="mt-3">Photo de couverture du groupe :</label>
                            <input id="couverture" name="couverture" type="file">
                        </div>
                        <div class="form-group">
