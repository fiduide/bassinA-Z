                ...
                <tr>
                    <td>
                        ...
                        <div class="form-group">
                            ...
                            <input class="photo" id="photo" name="p1" type="file">
                        </div>
                    </td>
                </tr>
            </table>
...
<script>
    function insertLastRow(){
      ...
      if(table.rows.length == 10){
        ...
        cell1.innerHTML='<div class="form-group">'+
                                ...
                                '<input  class="photo" id="fileInput" name="p'+nb_para+'" type="file">'+
                            '</div>';
      }
    }
    ...
    $("#fileInput").change(function(){
        var allowedTypes = ['video/mp4', 'video/x-msvideo', 'video/mpeg', 'video/ogg', 'video/webm'];
        var file = this.files[0];
        var fileType = file.type;
        if(!allowedTypes.includes(fileType)){
            alert('Please select a valid file (MP4/OGG/MPEG/WEBM/AVI).');
            $("#fileInput").val('');
            return false;
        }
    });
